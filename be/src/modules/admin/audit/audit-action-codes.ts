...
export const AuditActionCode = {
  ...
  INCIDENT_COMPENSATE_MANUAL_CORRECT: 'INCIDENT.COMPENSATE_MANUAL_CORRECT',
  INCIDENT_COMPENSATION_REVERSE: 'INCIDENT.COMPENSATION_REVERSE',
  INCIDENT_DEBT_WRITE_OFF: 'INCIDENT.DEBT_WRITE_OFF',
  BANK_STATEMENT_IMPORT: 'INCIDENT.BANK_STATEMENT_IMPORT',
  BANK_STATEMENT_MATCH: 'INCIDENT.BANK_STATEMENT_MATCH',
  BANK_STATEMENT_UNMATCH: 'INCIDENT.BANK_STATEMENT_UNMATCH',
  BANK_STATEMENT_IGNORE: 'INCIDENT.BANK_STATEMENT_IGNORE',
