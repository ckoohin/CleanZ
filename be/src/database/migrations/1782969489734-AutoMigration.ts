...
export class AutoMigration1782969489734 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_taskers_location_online"`,
    );
    await queryRunner.query(`DROP INDEX "public"."idx_blogs_category"`);
    await queryRunner.query(
      `ALTER TABLE "taskers" DROP COLUMN "current_location"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "pricing_configs" DROP CONSTRAINT "uq_pricing_service"`,
    );
    await queryRunner.query(
