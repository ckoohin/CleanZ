...
export class AutoMigration1781812154344 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "pricing_configs" DROP CONSTRAINT "FK_664f4525629e6c2874ba6a36b15"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "overdue_at"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "ticket_code" character varying(20)`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "description" text`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "category" "public"."ticket_category" NOT NULL DEFAULT 'OTHER'`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "subtype" character varying(100)`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."ticket_priority" AS ENUM('URGENT', 'HIGH', 'MEDIUM', 'LOW')`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "priority" "public"."ticket_priority" NOT NULL DEFAULT 'MEDIUM'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."ticket_source" AS ENUM('CUSTOMER_APP', 'TASKER_APP', 'ADMIN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "source" "public"."ticket_source" NOT NULL DEFAULT 'CUSTOMER_APP'`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "first_response_due_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "resolution_due_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "first_responded_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "resolved_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "closed_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "sla_paused_at" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "sla_paused_accum_ms" bigint NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "sla_breached" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."ticket_pending_reason" AS ENUM('WAIT_CUSTOMER', 'WAIT_TASKER', 'WAIT_INTERNAL')`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "pending_reason" "public"."ticket_pending_reason"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "incident_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "booking_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "reporter_user_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "counterparty_user_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "assigned_admin_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."cancelled_by" RENAME TO "cancelled_by_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."cancelled_by" AS ENUM('CUSTOMER', 'TASKER', 'SYSTEM', 'ADMIN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" ALTER COLUMN "cancelled_by" TYPE "public"."cancelled_by" USING "cancelled_by"::"text"::"public"."cancelled_by"`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_status_logs" ALTER COLUMN "cancelled_by" TYPE "public"."cancelled_by" USING "cancelled_by"::"text"::"public"."cancelled_by"`,
    );
    await queryRunner.query(`DROP TYPE "public"."cancelled_by_old"`);
    await queryRunner.query(
      `ALTER TABLE "wallets" DROP CONSTRAINT IF EXISTS "chk_wallet_owner"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."uq_wallets_system"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."idx_wallets_owner_type"`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."wallet_owner_type" RENAME TO "wallet_owner_type_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."wallets_owner_type_enum" AS ENUM('CUSTOMER', 'TASKER', 'SYSTEM')`,
    );
    await queryRunner.query(
      `ALTER TABLE "wallets" ALTER COLUMN "owner_type" TYPE "public"."wallets_owner_type_enum" USING "owner_type"::"text"::"public"."wallets_owner_type_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "services" DROP COLUMN "coverage_area"`,
    );
    await queryRunner.query(`ALTER TABLE "services" ADD "coverage_area" text`);
    await queryRunner.query(
      `ALTER TYPE "public"."voucher_type" RENAME TO "voucher_type_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."vouchers_type_enum" AS ENUM('PERCENT', 'FIXED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "vouchers" ALTER COLUMN "type" TYPE "public"."vouchers_type_enum" USING "type"::"text"::"public"."vouchers_type_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ALTER COLUMN "status" TYPE "public"."support_ticket_status" USING "status"::"text"::"public"."support_ticket_status"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket_status_logs" ALTER COLUMN "old_status" TYPE "public"."support_ticket_status" USING "old_status"::"text"::"public"."support_ticket_status"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket_status_logs" ALTER COLUMN "new_status" TYPE "public"."support_ticket_status" USING "new_status"::"text"::"public"."support_ticket_status"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "peak_rate" TYPE numeric(5,2)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ADD CONSTRAINT "chk_peak_day_range" CHECK ("start_at" < "end_at")`,
    );
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "pricing_configs" DROP CONSTRAINT "uq_pricing_service_duration"`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" DROP CONSTRAINT "chk_peak_day_range"`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."cancelled_by_old" AS ENUM('CUSTOMER', 'TASKER', 'SYSTEM')`,
    );
    await queryRunner.query(
      `ALTER TABLE "booking_status_logs" ALTER COLUMN "cancelled_by" TYPE "public"."cancelled_by_old" USING "cancelled_by"::"text"::"public"."cancelled_by_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" ALTER COLUMN "cancelled_by" TYPE "public"."cancelled_by_old" USING "cancelled_by"::"text"::"public"."cancelled_by_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."cancelled_by"`);
    await queryRunner.query(
      `ALTER TYPE "public"."cancelled_by_old" RENAME TO "cancelled_by"`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "peak_rate" SET DEFAULT 0.1`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "peak_day_configs"."peak_rate" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "peak_rate" TYPE numeric(5,4)`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "end_at" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "start_at" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "end_time" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "peak_day_configs" ALTER COLUMN "start_time" DROP NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."support_ticket_status_old" AS ENUM('OPEN', 'IN_PROGRESS', 'CLOSED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ALTER COLUMN "status" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ALTER COLUMN "status" TYPE "public"."support_ticket_status_old" USING "status"::"text"::"public"."support_ticket_status_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket_status_logs" ALTER COLUMN "old_status" TYPE "public"."support_ticket_status_old" USING "old_status"::"text"::"public"."support_ticket_status_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket_status_logs" ALTER COLUMN "new_status" TYPE "public"."support_ticket_status_old" USING "new_status"::"text"::"public"."support_ticket_status_old"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."support_ticket_status_old" RENAME TO "support_ticket_status"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."voucher_type_old" AS ENUM('PERCENT', 'FIXED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "vouchers" ALTER COLUMN "type" TYPE "public"."voucher_type_old" USING "type"::"text"::"public"."voucher_type_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."vouchers_type_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."voucher_type_old" RENAME TO "voucher_type"`,
    );
    await queryRunner.query(
      `ALTER TABLE "services" DROP COLUMN "coverage_area"`,
    );
    await queryRunner.query(
      `ALTER TABLE "services" ADD "coverage_area" geometry(MULTIPOLYGON,4326)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wallet_owner_type_old" AS ENUM('CUSTOMER', 'TASKER', 'SYSTEM')`,
    );
    await queryRunner.query(
      `ALTER TABLE "wallets" ALTER COLUMN "owner_type" TYPE "public"."wallet_owner_type_old" USING "owner_type"::"text"::"public"."wallet_owner_type_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."wallets_owner_type_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."wallet_owner_type_old" RENAME TO "wallet_owner_type"`,
    );
    await queryRunner.query(
      `CREATE INDEX "idx_wallets_owner_type" ON "wallets" ("owner_type")`,
    );
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "assigned_admin_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "counterparty_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "reporter_user_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "booking_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "incident_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "pending_reason"`,
    );
    await queryRunner.query(`DROP TYPE "public"."ticket_pending_reason"`);
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "sla_breached"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "sla_paused_accum_ms"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "sla_paused_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "closed_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "resolved_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "first_responded_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "resolution_due_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "first_response_due_at"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "subtype"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "support_tickets" DROP COLUMN "ticket_code"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pricing_configs" DROP COLUMN "duration_hours"`,
    );
    await queryRunner.query(
      `ALTER TABLE "support_tickets" ADD "overdue_at" TIMESTAMP`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "vouchers" ADD CONSTRAINT "FK_820556fd3264ae9abfe7cbc0734" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "pricing_configs" ADD CONSTRAINT "FK_664f4525629e6c2874ba6a36b15" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
}
