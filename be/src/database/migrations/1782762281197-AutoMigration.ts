...
export class AutoMigration1782762281197 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer_vouchers" DROP CONSTRAINT "uq_customer_voucher"`);
        ...
        await queryRunner.query(`ALTER TABLE "taskers" ADD "cancel_suspended_until" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "vouchers" ADD "reserved_count" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "vouchers" ADD "per_customer_limit" integer`);
        await queryRunner.query(`ALTER TABLE "customer_vouchers" ADD "reserved_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "customer_vouchers" ADD "booking_id" uuid`);
        await queryRunner.query(`ALTER TABLE "customer_vouchers" ADD "status" character varying(20) NOT NULL DEFAULT 'ISSUED'`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_tokens_user_type_expires" ON "tokens" ("expires_at", "type", "userId") `);
        await queryRunner.query(`ALTER TABLE "customer_vouchers" ADD CONSTRAINT "FK_280dc2ff901ba4b305398f7c2d1" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
