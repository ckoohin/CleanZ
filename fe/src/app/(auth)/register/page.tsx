...
export default function RegisterPage() {
  ...
  // Xử lý redirect cho Staff trong useEffect — tránh gọi router.push trong render
  useEffect(() => {
    if (confirmed && selectedRole === "staff") {
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
          ...
          >
            ...
            <div className={cn(
              "mt-6 flex items-center gap-2 text-sm font-bold transition-colors",
              selectedRole === "staff" ? "text-primary" : "text-muted-foreground group-hover:text-primary"
            )}>
          ...
          {selectedRole && (
            ...
            >
              ...
              <Button
                ...
                className="h-14 px-10 rounded-full text-lg font-bold shadow-lg shadow-primary/20 gap-2"
              >
        ...
        >
          ...
          {" · "}
          <Link href="/login-staff" className="text-primary font-bold hover:underline underline-offset-4">Đăng nhập Đối tác</Link>
        </motion.p>
      </div>
    </div>
  );
