...
import { VoucherListTable } from "@/features/admin/admin-voucher/components/VoucherListTable";
      ...
      <div className="w-full space-y-6">
        <div className="space-y-2 pl-2">
          ...
          <p className="text-muted-foreground text-sm max-w-2xl leading-relaxed">
            Quản lý mã giảm giá, điều kiện áp dụng, thời gian hiệu lực và trạng thái hoạt động trong hệ thống CleanZ.
          </p>
        </div>
        ...
        <div className="bg-card border-y sm:border sm:border-border/50 sm:rounded-2xl shadow-sm p-3 sm:p-4 w-full">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b">
            ...
            <h2 className="text-xl font-bold">Danh sách voucher CleanZ</h2>
          </div>
