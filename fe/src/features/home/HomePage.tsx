...
import { ServicesSection } from "@/features/home/_components/ServicesSection";
...
const WHY_US_ITEMS: WhyUsItem[] = [
  {
    ...
    desc: "Không phí ẩn hay tính giờ bất ngờ. Bạn biết chi phí trước khi đặt lịch.",
  },
  {
    icon: UserCheck,
    title: "Thợ được kiểm duyệt",
    desc: "Chỉ top 3% chuyên viên vượt qua vòng kiểm tra lý lịch và kỹ năng nhiều bước.",
  },
  {
    icon: Award,
    title: "Cam kết hoàn tiền",
    desc: "Không hài lòng? Chúng tôi sẽ xử lý hoặc hoàn tiền. Không cần giải thích.",
  },
];
...
export default function HomePagee() {
  return (
    <div className="min-h-screen bg-background">
      {/* Categories — floats over hero with negative margin */}
      <CategorySection
        items={CATEGORIES}
