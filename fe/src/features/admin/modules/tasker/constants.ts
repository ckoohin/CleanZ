...
/**
 * Định dạng ngày ngắn theo locale Việt Nam (dd/MM/yyyy).
 * Dùng chung cho các bảng/danh sách tasker. Giá trị truyền vào phải hợp lệ
 * (các nơi gọi đều đã guard null trước đó).
 */
export const formatDateVN = (value: string | number | Date): string =>
