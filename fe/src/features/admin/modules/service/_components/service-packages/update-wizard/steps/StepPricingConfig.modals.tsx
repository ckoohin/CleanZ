...
import {
  Loader2, MapPin, Edit, Search, Clock, ExternalLink, Calendar, Check, ScrollText,
} from "lucide-react";
...
import {
  AdminServiceEntity, CoverageAreaEntity, ServiceDurationEntity, ServicePeakHourEntity, AddonPriceUnit,
...
export interface StepPricingConfigModalsProps {
  ...
  // isOpenAddonDetailModal: cấu hình chi tiết đầy đủ cho addon (form thêm mới / sửa)
  ...
  // Cấu hình chi tiết khung giờ cao điểm (form thêm mới)
...
export function StepPricingConfigModals({
  ...
  newAddon, setNewAddon, ADDON_PRICE_UNIT_LABELS, isOpenAddonDetailModal, setIsOpenAddonDetailModal,
  ...
  return (
    <>
      ...
      {/* ── Dialog Cấu hình chi tiết dịch vụ thêm (form thêm mới / sửa) ── */}
