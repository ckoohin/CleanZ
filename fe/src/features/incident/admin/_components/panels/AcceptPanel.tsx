  ...
  return (
    <section className="space-y-2">
      ...
      <p className="rounded-lg border border-[var(--c-line)] bg-[var(--c-card-2)] p-2.5 text-[11px] leading-snug text-[var(--c-muted)]">
        Mức độ nghiêm trọng <b>do hệ thống tự xác định</b> (theo loại sự cố +
        tổng số tiền yêu cầu) và không chỉnh tay được. Khi tiếp nhận, sự cố
        chuyển sang <b>{STATUS_LABEL.REVIEWING}</b>, ví Tasker bị giữ tạm và
        Tasker bắt đầu được tính hạn giải trình.
      </p>
      ...
      >
        ...
        {accept.isPending ? "Đang tiếp nhận..." : "Tiếp nhận"}
      </AdminButton>
    </section>
  );
}
